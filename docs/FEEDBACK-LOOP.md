...
| Topic | Decision |
|-------|----------|
| Who can manage | Configurable via `$wgSaintapediaFeedbackAccessGroups` (LocalSettings.php only, F-08); default **sysop**. Option C (`user` = named accounts, not temp) is opt-in |
