...
CREATE TABLE IF NOT EXISTS /*_*/spf_feedback (
	...
	-- Private editor work notes (never on Talk; managers only)
	fb_work_note TEXT NULL DEFAULT NULL,

	-- When 1 and status=actioned, shown on the public resolutions list
	fb_resolution_public TINYINT(1) NOT NULL DEFAULT 0,
	-- Short public summary of what was done (no raw reader PII)
	fb_resolution_summary TEXT NULL DEFAULT NULL,
	...
	INDEX spf_public_res (fb_page_id, fb_resolution_public, fb_status)
) /*$wgDBTableOptions*/;
